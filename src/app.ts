  ...
  private template(): string {
    return `
      ...
      <div class="main">
        ...
        <div class="panels-right"><div class="panel"><div class="panel-header panel-header-actions"><span class="panel-title">Layers</span><div class="add-layer-group"><button id="add-layer-btn" class="opt-btn panel-add-btn" data-info="Add a new layer to the document.">+ Layer</button><div class="add-layer-dropdown"><button class="add-layer-action" data-add-layer="image">Image…</button></div></div></div><div class="panel-body"><div id="layers-list" class="layers-list"></div></div></div><div class="panel"><div class="panel-header"><span class="panel-title">Transform</span></div><div class="panel-body transform-grid"><label>X <input id="transform-x" class="opt-select" type="number"></label><label>Y <input id="transform-y" class="opt-select" type="number"></label><label>W <input id="transform-w" class="opt-select" type="number"></label><label>H <input id="transform-h" class="opt-select" type="number"></label></div></div></div>
      </div>
